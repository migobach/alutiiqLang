              ...
              <Grid.Row centered columns={2} divided>
                <Grid.Column textAlign='center'>
                  <SpecialDiv>
                    ...
                    <ContentStyle>
                      <ContentEditable
                        html={(this.props.editables.length >= 1 && this.props.editables.find(val => val.name === 'footerLeftBody') !== undefined) ? this.props.editables.find(val => val.name === 'footerLeftBody').textLong :
                          'Native Village of Afognak | 907.486.6357 | tribe@afognak.org'}
                        disabled={this.props.user.id ? false : true}
                        onChange={this.handleChangeEditable}
