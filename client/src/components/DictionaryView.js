...
class DictionaryView extends Component {
  ...
  handleSentence = () => {
    ...
    } else if (this.props.word.north_sentence !== null || this.props.word.north_sentence !== "") {
      return (
        <div>
    ...
    } else if (this.props.word.south_sentence !== null || this.props.word.south_sentence !== "") {
      return (
        <div>
    ...
    return (
      <div>
        <SpecialDiv>
          ...
          {(this.props.word.parth_of_speech !== "" || this.props.word.parth_of_speech !== null) ?
            <div>
              <ContentStyleThick>
                Part of speech:
              </ContentStyleThick>
          ...
          {(this.props.word.category !== "" || this.props.word.category !== null) ?
            <div>
              < br />
              <ContentStyleThick>
                Category of speech:
          ...
          {(this.props.word.examples_conjugation_irregulars !== "" || this.props.word.examples_conjugation_irregulars !== null) ?
            <div>
              <ContentStyleThick>
                Examples / Conjugations / Irregulars:
              </ContentStyleThick>
          ...
          {(this.props.word.cultural_significance !== "" || this.props.word.cultural_significance !== null) ?
            <div>
              <ContentStyleThick>
                Cultural notes:
              </ContentStyleThick>
          ...
          {(this.props.word.negatives !== "" || this.props.word.negatives !== null) ?
            <div>
              <ContentStyleThick>
                Negative forms:
              </ContentStyleThick>
          ...
          {(this.props.word.additional_meanings !== "" || this.props.word.additional_meanings !== null ) ?
            <div>
              <ContentStyleThick>
                Additional meanings:
              </ContentStyleThick>
